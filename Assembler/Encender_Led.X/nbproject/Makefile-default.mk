...
FINAL_IMAGE=${DISTDIR}/1_Encender_Led.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=programa1.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/programa1.o
POSSIBLE_DEPFILES=${OBJECTDIR}/programa1.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/programa1.o

# Source Files
SOURCEFILES=programa1.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/1_Encender_Led.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F45K50
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/1_Encender_Led.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/programa1.o: programa1.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/programa1.o 
	${MP_AS} -mcpu=PIC18F45K50 -c \
	-o ${OBJECTDIR}/programa1.o \
	programa1.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/1_Encender_Led.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F45K50 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/1_Encender_Led.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
