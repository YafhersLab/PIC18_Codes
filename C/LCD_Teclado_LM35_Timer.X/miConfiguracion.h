//Con idndef verificamos que el archivo no ha sido definido anteriormente
//Si ya esta definido el código entre ifndef y endif no se ejecutará
//sirve para evitar redifiniciones
